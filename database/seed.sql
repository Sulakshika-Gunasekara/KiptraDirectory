...
('Attractions', 'fas fa-landmark', 'https://images.unsplash.com/photo-1508915993299-0435c2427a4a?q=80&w=2070&auto=format&fit=crop'),
('Activities', 'fas fa-hiking', 'https://images.unsplash.com/photo-1551632811-561732d1e306?q=80&w=2070&auto=format&fit=crop'),
('Services', 'fas fa-concierge-bell', 'https://images.unsplash.com/photo-1517048676732-d65bc937f952?q=80&w=2070&auto=format&fit=crop'),
('Events', 'fas fa-calendar-alt', 'https://images.unsplash.com/photo-1511795409834-ef04bbd51622?q=80&w=2070&auto=format&fit=crop');
...
-- Listings
-- Note: The category_id corresponds to the categories above (1-10)
...
('Barefoot', 'A vibrant shop with handloom textiles, books, and a charming cafe.', 6, 'Colombo, Sri Lanka', '+94 11 258 9701', 4.6, NULL, 'https://images.unsplash.com/photo-1555529669-e69e7aa0ba9a?q=80&w=2070&auto=format&fit=crop'),
('Sigiriya Rock Fortress', 'Climb the ancient rock fortress for breathtaking views and a glimpse into Sri Lanka''s history.', 7, 'Sigiriya, Sri Lanka', '', 4.9, NULL, 'https://images.unsplash.com/photo-1508915993299-0435c2427a4a?q=80&w=2070&auto=format&fit=crop'),
('Whale Watching in Mirissa', 'Experience the thrill of seeing blue whales and dolphins in their natural habitat.', 8, 'Mirissa, Sri Lanka', '', 4.7, NULL, 'https://images.unsplash.com/photo-1551632811-561732d1e306?q=80&w=2070&auto=format&fit=crop'),
('Ayurvedic Spa Treatment', 'Rejuvenate your body and mind with a traditional Ayurvedic spa treatment.', 9, 'Various locations', '', 4.8, NULL, 'https://images.unsplash.com/photo-1517048676732-d65bc937f952?q=80&w=2070&auto=format&fit=crop'),
('Kandy Esala Perahera', 'A grand Buddhist festival with elephants, dancers, and drummers.', 10, 'Kandy, Sri Lanka', '', 4.9, NULL, 'https://images.unsplash.com/photo-1511795409834-ef04bbd51622?q=80&w=2070&auto=format&fit=crop');
